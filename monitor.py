...
.gmico{margin-left:auto}.ico img{display:block;border-radius:3px}
...
const links=x=>{let h="";if(x.website)h+=`<a class="ico" href="${esc(x.website)}" target="_blank" rel="noopener" title="Website">${SVG.web}</a>`;if(x.twitter)h+=`<a class="ico" href="${esc(x.twitter)}" target="_blank" rel="noopener" title="Twitter">${SVG.x}</a>`;if(x.telegram)h+=`<a class="ico" href="${esc(x.telegram)}" target="_blank" rel="noopener" title="Telegram">${SVG.tg}</a>`;h+=`<a class="ico gmico" href="https://gmgn.ai/sol/token/${esc(x.ca)}" target="_blank" rel="noopener" title="GMGN"><img src="https://gmgn.ai/static/opstatic/GMGN_logo.svg" width="15" height="15" alt="GMGN"></a>`;return h};
